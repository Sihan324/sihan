...
- Scenario forecasts could use low, medium and high TFR paths to show how sensitive live-birth forecasts are to fertility assumptions.

These extensions are not included in the current final model because the report prioritises a reproducible ARIMA workflow with transparent diagnostics. They would be appropriate if the goal were a policy-grade demographic forecast rather than a course project demonstrating time series modelling.
